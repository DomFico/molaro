 ...
 * exactly our four MCP tools. A deny-list only catches names someone thought to
 ...
 * green deny-list. This test fails the moment ANY tool beyond our four appears.
 *
...
test("runtime tool surface EQUALS exactly our four MCP tools — nothing else", async () => {
  ...
  assert.deepEqual(
    tools, expected,
    `the runtime surface must be EXACTLY our four MCP tools. Unexpected tool(s) present: ` +
